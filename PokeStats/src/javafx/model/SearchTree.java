...
public class SearchTree<Value> {
	...
	public String autocorrect(String prefix) {
		return getNextChar(prefix, root, "");
	}
	...
	private String getNextChar(String prefix, Node<Value> x, String i) {
		if (x == null)
			return null;
		
		char c = prefix.charAt(i.length());
